...
01. Moodle Admin Guide
    * Create courses [(Create category,Create courses ,Add bulk course,Delete courses)](https://github.com/LEARN-LK/lms/blob/master/add.md#-adding-a-course-category-)
